...
internal class MathMlMarkupBuilder
{
    ...
    protected static bool TryGetSymbol(Symbol symbol, out DisplayDetail? entry, bool fixPhi = true)
    {
        ...
        entry = (symbol, fixPhi) switch
        {
            ...
            (Symbol.sin, _) => new("sin", DisplaySymbolType.Operator),
            (Symbol.Sin, _) => new("Sin", DisplaySymbolType.Operator),
            (Symbol.cos, _) => new("cos", DisplaySymbolType.Operator),
            (Symbol.Cos, _) => new("Cos", DisplaySymbolType.Operator),
            (Symbol.tan, _) => new("tan", DisplaySymbolType.Operator),
            (Symbol.Tan, _) => new("Tan", DisplaySymbolType.Operator),
            (Symbol.sinh, _) => new("sinh", DisplaySymbolType.Operator),
            (Symbol.Sinh, _) => new("Sinh", DisplaySymbolType.Operator),
            (Symbol.cosh, _) => new("cosh", DisplaySymbolType.Operator),
            (Symbol.Cosh, _) => new("Cosh", DisplaySymbolType.Operator),
            (Symbol.tanh, _) => new("tanh", DisplaySymbolType.Operator),
            (Symbol.Tanh, _) => new("Tanh", DisplaySymbolType.Operator),
            (Symbol.cot, _) => new("cot", DisplaySymbolType.Operator),
            (Symbol.Cot, _) => new("Cot", DisplaySymbolType.Operator),
            (Symbol.sec, _) => new("sec", DisplaySymbolType.Operator),
            (Symbol.Sec, _) => new("Sec", DisplaySymbolType.Operator),
            (Symbol.csc, _) => new("csc", DisplaySymbolType.Operator),
            (Symbol.Csc, _) => new("Csc", DisplaySymbolType.Operator),
            (Symbol.arcsin, _) => new("arcsin", DisplaySymbolType.Operator),
            (Symbol.arccos, _) => new("arccos", DisplaySymbolType.Operator),
            (Symbol.arctan, _) => new("arctan", DisplaySymbolType.Operator),
            (Symbol.coth, _) => new("coth", DisplaySymbolType.Operator),
            (Symbol.sech, _) => new("sech", DisplaySymbolType.Operator),
            (Symbol.csch, _) => new("csch", DisplaySymbolType.Operator),
            (Symbol.exp, _) => new("exp", DisplaySymbolType.Operator),
            ...
            (Symbol.log, _) => new("log", DisplaySymbolType.Operator),
            (Symbol.Log, _) => new("Log", DisplaySymbolType.Operator),
            (Symbol.ln, _) => new("ln", DisplaySymbolType.Operator),
            (Symbol.Ln, _) => new("Ln", DisplaySymbolType.Operator),
            (Symbol.det, _) => new("det", DisplaySymbolType.Operator),
            (Symbol.dim, _) => new("dim", DisplaySymbolType.Operator),
            (Symbol.ker, _) => new("ker", DisplaySymbolType.Operator),
            (Symbol.mod, _) => new("mod", DisplaySymbolType.Operator),
            (Symbol.gcd, _) => new("gcd", DisplaySymbolType.Operator),
            (Symbol.lcm, _) => new("lcm", DisplaySymbolType.Operator),
            (Symbol.lub, _) => new("lub", DisplaySymbolType.Operator),
            (Symbol.glb, _) => new("glb", DisplaySymbolType.Operator),
